...
interface MountainLayerProps {
  ...
  heightClass: string; // Will now be a calculated class like h-[calc(100vh+Xpx)]
  viewBox?: string;
}
...
const MountainLayer: FC<MountainLayerProps> = ({
  ...
  return (
    <motion.svg
      ...
      // Changed from `absolute inset-x-0 bottom-0` to `absolute inset-x-0 top-0`
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      ...
      <MountainLayer
        ...
        yOffsetRange={[0, -40]}
        heightClass="h-[calc(100vh+40px)]" // Adjusted height
        viewBox="0 0 1440 400"
      />
      ...
      <MountainLayer
        ...
        yOffsetRange={[0, -80]}
        heightClass="h-[calc(100vh+80px)]" // Adjusted height
        viewBox="0 0 1440 400"
      />
      ...
      <MountainLayer
        ...
        yOffsetRange={[0, -130]}
        heightClass="h-[calc(100vh+130px)]" // Adjusted height
        viewBox="0 0 1440 400"
      />
      ...
      <MountainLayer
        ...
        opacityClass="opacity-100"
        yOffsetRange={[0, -200]}
        heightClass="h-[calc(100vh+200px)]" // Adjusted height
        viewBox="0 0 1440 400"
      />
    </div>
  );
