...
const MountainParallaxBackground: FC = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      {/* Layer 4: Furthest, very dark upper sky */}
      <MountainLayer
        d="M0,400 L0,320 Q360,280 720,300 T1440,270 L1440,400 Z"
        fillClass="fill-slate-900" // Very dark blueish-gray, almost black
        opacityClass="opacity-100"
        yOffsetRange={[0, -40]}
        heightClass="h-[calc(100vh+40px)]"
        viewBox="0 0 1440 400"
      />
      {/* Layer 3: Sunset glow band */}
      <MountainLayer
        ...
        fillClass="fill-orange-700" // Dark, rich orange for sunset band
        opacityClass="opacity-90"
        yOffsetRange={[0, -80]}
        heightClass="h-[calc(100vh+80px)]"
        viewBox="0 0 1440 400"
      />
      {/* Layer 2: Mid-ground silhouetted mountains */}
      <MountainLayer
        d="M0,400 L0,280 L200,350 L380,260 L550,340 L720,240 L900,330 L1050,250 L1200,320 L1350,270 L1440,300 L1440,400 Z"
        fillClass="fill-neutral-800" // Dark gray silhouette
        opacityClass="opacity-100"
        yOffsetRange={[0, -130]}
        heightClass="h-[calc(100vh+130px)]"
        viewBox="0 0 1440 400"
      />
      {/* Layer 1: Closest, darkest silhouetted mountains */}
      <MountainLayer
        ...
        fillClass="fill-neutral-950" // Almost black silhouette
        opacityClass="opacity-100"
        yOffsetRange={[0, -200]}
